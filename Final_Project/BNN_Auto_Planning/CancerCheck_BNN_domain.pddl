(define (domain CancerCheck_BNN)
  ...
  (:constants
    ...
    concavepoints_mean concavepoints_se concavepoints_worst
...
;; --- compactness Actions (All 27 combinations) ---
 ...
 (:action concavepoints_hhh
    ...
    :precondition (and (weights-initialized)
                       ...
                       (has-value concavepoints_worst high))
    :effect (and
              (test-performed concavepoints_mean)
              (test-performed concavepoints_se)
              (test-performed concavepoints_worst)
              (increase (total-cost) 3))
  )

  (:action concavepoints_hhm
    :parameters ()
    :precondition (and (weights-initialized)
                       (not (test-performed concavepoints_mean))
                       (not (test-performed concavepoints_se))
                       ...
                       (has-value concavepoints_mean high)
                       (has-value concavepoints_se high)
                       (has-value concavepoints_worst medium))
    :effect (and
              (test-performed concavepoints_mean)
              (test-performed concavepoints_se)
              (test-performed concavepoints_worst)
  ...
  (:action concavepoints_hmh
    ...
    :precondition (and (weights-initialized)
                       ...
                       (not (test-performed concavepoints_worst))
                       (has-value concavepoints_mean high)
                       (has-value concavepoints_se medium)
                       (has-value concavepoints_worst high))
    :effect (and
              (test-performed concavepoints_mean)
              (test-performed concavepoints_se)
  ...
  (:action concavepoints_hlh
    ...
    :precondition (and (weights-initialized)
                       ...
                       (not (test-performed concavepoints_worst))
                       (has-value concavepoints_mean high)
                       (has-value concavepoints_se low)
                       (has-value concavepoints_worst high))
    :effect (and
              (test-performed concavepoints_mean)
              (test-performed concavepoints_se)
  ...
  (:action concavepoints_mhh
    :parameters ()
    :precondition (and (weights-initialized)
                       (not (test-performed concavepoints_mean))
                       (not (test-performed concavepoints_se))
                       (not (test-performed concavepoints_worst))
                       (has-value concavepoints_mean medium)
                       (has-value concavepoints_se high)
                       (has-value concavepoints_worst high))
    :effect (and
              (test-performed concavepoints_mean)
  ...
  (:action concavepoints_lhh
    :parameters ()
    :precondition (and (weights-initialized)
                       (not (test-performed concavepoints_mean))
                       (not (test-performed concavepoints_se))
                       (not (test-performed concavepoints_worst))
                       (has-value concavepoints_mean low)
                       (has-value concavepoints_se high)
                       (has-value concavepoints_worst high))
    :effect (and
              (test-performed concavepoints_mean)
  ...
  (:action fractaldimension_hhh
    ...
    :precondition (and (weights-initialized)
                       ...
                       (test-performed compactness_se)
                       (test-performed compactness_worst)
                       (not (test-performed fractaldimension_mean))
                       (not (test-performed fractaldimension_se))
                       (not (test-performed fractaldimension_worst))
                       (has-value concavity_mean high)
                       (has-value concavity_se high)
                       (has-value concavity_worst high))
    :effect (and
              (test-performed fractaldimension_mean)
              (test-performed fractaldimension_se)
              (test-performed fractaldimension_worst)
              (increase (total-cost) 3))
  )

  (:action fractaldimension_hhm
    :parameters ()
    :precondition (and (weights-initialized)
                       (test-performed concavity_mean)
                       (test-performed concavity_se)
